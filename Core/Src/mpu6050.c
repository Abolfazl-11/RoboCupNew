...
const double x_calibration = 0;
const double y_calibration = 0;
const double z_calibration = 0;
...
void MPU6050_Read_Gyro(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    DataStruct->Gx = DataStruct->Gyro_X_RAW / 131.0 + x_calibration;
    DataStruct->Gy = DataStruct->Gyro_Y_RAW / 131.0 + y_calibration;
    DataStruct->Gz = DataStruct->Gyro_Z_RAW / 131.0 + z_calibration;
}
